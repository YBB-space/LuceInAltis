(() => {
  ...
  const pages = {
    ...
    "structure.html": {
      ...
      "핀캔 설계 및 제작": "Fin-Can Design and Fabrication",
      "핀부터 성형 몰드와 지그까지 직접": "Fins, compression molds, and jigs made in-house",
      "로켓의 자세 안정성을 좌우하는 핀캔 조립체를 압축 성형 몰드 방식으로 제작합니다. 분절형과 일체형 구조의 하중 전달 특성을 비교하고, CFRP 핀과 핀 지그까지 직접 제작해 형상과 정렬의 재현성을 확보합니다.": "We fabricate the fin-can assembly, which governs vehicle stability, using compression molds. We compare load transfer in segmented and integrated structures and make both CFRP fins and fin jigs in-house for repeatable geometry and alignment.",
